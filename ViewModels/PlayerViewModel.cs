...
public partial class PlayerViewModel : ObservableObject, IEquatable<PlayerViewModel?>
{
    ...
    public string R1 { get => GetRoundResult(1); }
    public string R2 { get => GetRoundResult(2); }
    public string R3 { get => GetRoundResult(3); }
    public string R4 { get => GetRoundResult(4); }
    public string R5 { get => GetRoundResult(5); }
    public string R6 { get => GetRoundResult(6); }
    public string R7 { get => GetRoundResult(7); }
    public string R8 { get => GetRoundResult(8); }
    public string R9 { get => GetRoundResult(9); }
    public string R10 { get => GetRoundResult(10); }
