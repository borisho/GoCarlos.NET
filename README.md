...
- Customizable Super group score gap,
...
.NET 10 needs to be installed for Portable versions. Others x64 and x86 are self-contained and can run without .NET installed.
